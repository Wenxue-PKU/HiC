...
Description
	...
	-r, --resolution [resolution list]
		resolution list separated by ,. For example 5000,10000,20000,100000
...
SHORT=hi:o:r:q:x:
LONG=help,in:,out:,resolution:,mapQ:,ref:
...
java -Xmx8g -jar $PROGRAM_JUICER pre -r ${RESOLUTION} -q $THRESHOLD_MAPQ -t ${DIR_tmp} ${FILE_data} ${FILE_hic} $CHROM_SIZE
